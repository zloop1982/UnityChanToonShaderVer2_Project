...
Shader "UnityChanToonShader/Lightweight Render Pipeline/NoOutline/ToonColor_DoubleShadeWithFeather_Clipping_StencilMask" {
    Properties {
...
//MatcapMask
        _Set_MatcapMask ("Set_MatcapMask", 2D) = "black" {}
        _Tweak_MatcapMaskLevel ("Tweak_MatcapMaskLevel", Range(-1, 1)) = 1
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/Lightweight Render Pipeline/Toon_DoubleShadeWithFeather_Clipping_StencilMask/FORWARD"
        UsePass "UnityChanToonShader/Lightweight Render Pipeline/Toon_DoubleShadeWithFeather_Clipping_StencilMask/FORWARD_DELTA"
        UsePass "UnityChanToonShader/Lightweight Render Pipeline/Toon_DoubleShadeWithFeather_Clipping_StencilMask/SHADOWCASTER"
    }
